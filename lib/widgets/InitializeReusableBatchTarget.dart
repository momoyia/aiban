...
import '../screens/SetPermissiveFeatureOwner.dart';

class GetLastDescriptionDelegate extends StatelessWidget {
  final AggregateGreatHeadCache story;
  final Function(int)? onUserBlocked;

  const GetLastDescriptionDelegate({
    super.key,
    required this.story,
    this.onUserBlocked,
  });
